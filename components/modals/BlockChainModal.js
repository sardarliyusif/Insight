...
export default function BlockChainModal({ setShowBlockChainModal, showBlockChainModal }) {
        ...
        >
          ...
          <ul>
            <li className="border-b flex items-center border-[#D6D6D6] px-9 py-7">
              ...
              <p>Celo</p>
              <p className="absolute left-1/2">${donutData.firstExample > 999999 ? `${donutData.firstExample/1000000}M` : donutData.firstExample.toLocaleString("en-US")}</p>
              <p>{Math.round(donutData.firstExample/totalDonutData*100)}%</p>
              </div>
            </li>
            <li className="border-b flex items-center border-[#D6D6D6] px-9 py-7">
              ...
              <div className="flex justify-between flex-1 font-medium text-base relative">
              <p>Solana</p>
              <p className="absolute left-1/2">${donutData.secondExample > 999999 ? `${donutData.secondExample/1000000}M` : donutData.secondExample.toLocaleString("en-US")}</p>
              <p>{Math.round(donutData.secondExample/totalDonutData*100)}%</p>
              </div>
            ...
            <li className="border-b flex items-center border-[#D6D6D6] px-9 py-7">
              ...
              <div className="flex justify-between flex-1 font-medium text-base relative">
              <p>Ethereum</p>
              <p className="absolute left-1/2">${donutData.thirdExample > 999999 ? `${donutData.thirdExample/1000000}M` : donutData.thirdExample.toLocaleString("en-US")}</p>
              <p>{Math.round(donutData.thirdExample/totalDonutData*100)}%</p>
              </div>
            ...
            <li className="border-b flex items-center border-[#D6D6D6] px-9 py-7">
              ...
              <div className="flex justify-between flex-1 font-medium text-base relative">
              <p>Avalanche</p>
              <p className="absolute left-1/2">${donutData.fourthExample > 999999 ? `${donutData.fourthExample/1000000}M` : donutData.fourthExample.toLocaleString("en-US")}</p>
              <p>{Math.round(donutData.fourthExample/totalDonutData*100)}%</p>
              </div>
